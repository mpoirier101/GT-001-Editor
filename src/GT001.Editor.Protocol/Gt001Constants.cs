...
public static class Gt001Constants
{
    ...
    public const byte DeviceIdOne = 0x00;
    public const byte DefaultOutboundDeviceId = DeviceIdOne;

    public static readonly byte[] ModelId = [0x00, 0x00, 0x00, 0x06];
    public static readonly byte[] IdentityRequest = [0xF0, 0x7E, BroadcastDeviceId, 0x06, 0x01, 0xF7];
